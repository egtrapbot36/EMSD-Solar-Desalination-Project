...
#define AIO_KEY         "aio_JTpQ71zt5EhnYDGA6BfoINEmeDiW"
...
Adafruit_MQTT_Publish RelayAcid  = Adafruit_MQTT_Publish(&mqtt, AIO_USERNAME "/feeds/relay_acid");
Adafruit_MQTT_Publish RelayBase  = Adafruit_MQTT_Publish(&mqtt, AIO_USERNAME "/feeds/relay_base");
Adafruit_MQTT_Publish RelayNA    = Adafruit_MQTT_Publish(&mqtt, AIO_USERNAME "/feeds/relay_nA");
Adafruit_MQTT_Publish RelayNB    = Adafruit_MQTT_Publish(&mqtt, AIO_USERNAME "/feeds/relay_nB");
//Adafruit_MQTT_Publish RelaySalt  = Adafruit_MQTT_Publish(&mqtt, AIO_USERNAME "/feeds/relay_salt");
Adafruit_MQTT_Publish RelayFresh = Adafruit_MQTT_Publish(&mqtt, AIO_USERNAME "/feeds/relay_fresh");
...
void publish_data() {
  ...
  SensorConductivity.publish(ppm_cur);
  SensorAcid.publish(pH_cur);
...
//  Serial.println(data);
  ...
  relay_acid   = Serial.parseInt();
  relay_base   = Serial.parseInt();
  relay_nA     = Serial.parseInt();
  relay_nB     = Serial.parseInt();
  relay_salt   = Serial.parseInt();
  relay_fresh  = Serial.parseInt();
  
  batt_cur  = Serial.parseFloat();
  pH_cur    = Serial.parseFloat();
  ppm_cur   = Serial.parseFloat();
  temp_cur  = Serial.parseFloat();
}
